...
const LinkDepartmentCourse = () => {
    ...
    const fetchLinkedDepartment = async () => {
        try {
            ...
            const response = await axiosPrivate.get(
                '/admin/department?status=linked'
            )
    ...
    const fetchDepartmnet = async () => {
        try {
            ...
            const response = await axiosPrivate.get(
                '/admin/department?status=unlinked'
            )
                    ...
                    <div className="searchBar">
                        ...
                        <label className="input input-bordered flex items-center gap-2">
                            <input
                                ...
                                onChange={(event) =>
                                    handleInputChange(event, 'linkedCourse')
                                }
                                onKeyDown={(event) =>
                                    handleKeyPress(event, 'linkedCourse')
                                }
                            />
                            <svg
                                ...
                                onClick={() =>
                                    handleSearchIconClick('linkedCourse')
                                }
                            >
                                <path
                                    fillRule="evenodd"
                    ...
                    <div className="searchBar">
                        ...
                        <label className="input input-bordered flex items-center gap-2">
                            <input
                                ...
                                onChange={(event) =>
                                    handleInputChange(event, 'linkedDeps')
                                }
                                onKeyDown={(event) =>
                                    handleKeyPress(event, 'linkedDeps')
                                }
                            />
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                className="w-4 h-4 opacity-70 cursor-pointer"
                                onClick={() =>
                                    handleSearchIconClick('linkedDeps')
                                }
                            >
                                <path
                                    fillRule="evenodd"
                    ...
                    <div className="searchBar">
                        ...
                        <label className="input input-bordered flex items-center gap-2">
                            <input
                                ...
                                onChange={(event) =>
                                    handleInputChange(event, 'courseList')
                                }
                                onKeyDown={(event) =>
                                    handleKeyPress(event, 'courseList')
                                }
                            />
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                className="w-4 h-4 opacity-70 cursor-pointer"
                                onClick={() =>
                                    handleSearchIconClick('courseList')
                                }
                            >
                                <path
                                    fillRule="evenodd"
                        ...
                        <div className="searchBar">
                            ...
                            <label className="input input-bordered flex items-center gap-2">
                                <input
                                    ...
                                    onKeyDown={(event) =>
                                        handleKeyPress(event, 'departmentList')
                                    }
                                />
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    className="w-4 h-4 opacity-70 cursor-pointer"
                                    onClick={() =>
                                        handleSearchIconClick('departmentList')
                                    }
                                >
                                    <path
                                        fillRule="evenodd"
