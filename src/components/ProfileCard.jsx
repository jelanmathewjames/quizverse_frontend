...
function ProfileCard(props) {
    ...
    return (
        <div className="relative mt-5">
            <img src={avatar} alt={props.username} className="absolute -top-5 border-gray-300 border-[1px]  shadow-2xl mb-2 left-1/2 transform -translate-x-1/2 w-28  rounded-lg p-4 z-10" />
