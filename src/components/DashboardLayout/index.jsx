...
const DashboardLayout = ({ navitems, children, title }) => {
    ...
    return (
        <>
            <nav
                className={`fixed top-1 left-1 right-1 z-10 rounded-xl bg-base-100 lg:hidden shadow-md transition-all duration-300 ${isNavVisible ? 'translate-y-0' : '-translate-y-full'}`}
            >
                <div className=" flex items-center justify-between py-4 px-6  ">
                    <div className="flex items-center left-0 ">
                        ...
                        <h1 className="text-2xl font-semibold ml-[300px] hidden lg:block">
                            Hello{' '}
                        </h1>
            ...
            <div className="drawer lg:drawer-open ">
                ...
                <div className="drawer-side z-20  ">
                    ...
                    <ul className="menu p-4 w-80 min-h-full bg-base-100   text-base-content  border-base-300 ">
                        ...
                        <h1 className="text-3xl p-4 pb-0 gradient-text font-bold">
                            QuizVerse{' '}
                        </h1>
                        <span className=" m-3  mb-5 badge badge-ghost font-semibold ">
                            {title}
                        </span>
                        {navitems.map((item, index) => (
                            ...
                            >
                                <button onClick={() => setOption(index)}>
                                    {' '}
                                    {item.name}
                                </button>
                            </li>
                        ...
                        <li
                            className={` font-bold text-[16px] shadow-sm  rounded-lg mb-4`}
                        >
